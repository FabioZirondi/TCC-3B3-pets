...
<body>
    ...
    <main>
        ...
        <br />
        <div class="form">
            <form class="container-form" action="../php/editarproduto.php" method="POST" enctype="multipart/form-data">
                <h1>Editar produto</h1>
                <p><b>Edite todos os componentes.</b></p>
                <p><b>Todos os dados serão alterados após o envio!</b></p>
                ...
                <?php  echo "<input type='hidden' name='produto_id' value='{$id_produto}'>";?>
